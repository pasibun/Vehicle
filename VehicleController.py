import multiprocessing, time, PlaystationController, MqttController
from multiprocessing import Process
from MqttController import *
from PlaystationController import *
...
class TubberCar:
    ...
    def __init__(self):
        ...
        try:
            mqtt = MqttController()
            p1 = multiprocessing.Process(target=mqtt.connectAndSubscribe, args=(self.subscribeTB,'TubberCar',))
            p1.deamon = True
            p1.start()            
